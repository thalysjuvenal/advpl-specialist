...
| Ponto de Entrada MVC | .prw ou .tlpp | patterns-pontos-entrada-mvc.md |
| Web Service SOAP | .prw | patterns-soap.md |
| Relatorio PDF (por coordenadas) | .prw | patterns-fwmsprinter.md |
...
- **patterns-fwmsprinter.md** - Padroes para relatorios PDF por coordenadas com FWMSPrinter (TFont, TBrush, SayAlign, FillRect, layout em pixels)
...
- **patterns-pontos-entrada-mvc.md** - Padroes para pontos de entrada em rotinas padrao MVC (PE unico por rotina nomeado pelo ID do modelo, eventos via PARAMIXB[2]: MODELVLDACTIVE, MODELPOS, MODELCOMMITTTS, BUTTONBAR, etc.), com tabela oficial de eventos, SetErrorMessage e exemplos ITEM/CUSTOMERVENDOR
